...
QUESTION_PROMPT_OVERRIDES: Dict[str, str] = {
    ...
    "Funding: Cost of implementing integration and who paid": (
        ...
        "Fallback: If no monetary cost is stated but funders are named, return 'Cost: cost not reported; Funder(s): <named funders>'. "
        "If neither cost nor funders are stated, return 'Not reported'."
    ),
